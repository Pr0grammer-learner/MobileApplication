package com.mirea.privalov.yandexdriver;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {
    ...
    private void submitRequest() {
        ...
        if (task) {
            ROUTE_START_LOCATION = new Point(55.803438, 37.970820);
            ROUTE_END_LOCATION = new Point(55.79424375563888, 37.699661753948455);
        }
        ...
        if (task) {
            ...
            marker.addTapListener(new MapObjectTapListener() {
                ...
                public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                        point) {
                    Toast.makeText(getApplication(),"МИРЭА Стромынка 20",
